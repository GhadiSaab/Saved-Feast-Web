                ...
                <div class="row g-4">
                                    ...
                                    <div class="col-md-3 col-6">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="allergen_{{ Str::slug($allergen) }}" 
                                                   ...
                                                   {{ in_array($allergen, $oldAllergens) ? 'checked' : '' }}>
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" step="0.01" class="form-control @error('original_price') is-invalid @enderror" id="original_price" name="original_price" value="{{ old('original_price') }}" required>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" step="0.01" class="form-control @error('discounted_price') is-invalid @enderror" id="discounted_price" name="discounted_price" value="{{ old('discounted_price') }}" required>
                            @error('discounted_price')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                            <div id="discount-percentage" class="form-text">Discount: <span>0</span>%</div>
                        </div>
                        
                        <div class="mb-4">
                            <label for="available_quantity" class="form-label">Available Quantity</label>
                            <input type="number" min="1" class="form-control @error('available_quantity') is-invalid @enderror" id="available_quantity" name="available_quantity" value="{{ old('available_quantity', 1) }}" required>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="datetime-local" class="form-control @error('available_from') is-invalid @enderror" id="available_from" name="available_from" value="{{ old('available_from', now()->format('Y-m-d\TH:i')) }}" required>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="datetime-local" class="form-control @error('available_until') is-invalid @enderror" id="available_until" name="available_until" value="{{ old('available_until', now()->addDay()->format('Y-m-d\TH:i')) }}" required>
                        ...
                        <div class="mb-4">
                            ...
                            @error('image')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                            <div class="form-text">Recommended: square image (1:1 ratio), max 2MB</div>
                        </div>
