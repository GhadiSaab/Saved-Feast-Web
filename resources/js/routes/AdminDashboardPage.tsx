...
const AdminDashboardPage: React.FC = () => {
    const [activeTab, setActiveTab] = useState<'overview' | 'users' | 'restaurants' | 'orders' | 'meals' | 'analytics'>('overview');
                    ...
                    <div className="col-md-6">
                        <div className="card">
                            ...
                            <div className="card-body">
                                <div className="row">
                                    <div className="col-6">
                                        <p><strong>New This Month:</strong> {overview.users.new_this_month}</p>
                                        <p><strong>Active Users:</strong> {overview.users.active}</p>
                                    </div>
                                    <div className="col-6">
                                        <p><strong>Total Meals:</strong> {overview.meals.total}</p>
                                        <p><strong>Active Meals:</strong> {overview.meals.active}</p>
                                    </div>
                                </div>
                                <div className="mt-3">
                    ...
                    <div className="col-md-6">
                        <div className="card">
                            ...
                            <div className="card-body">
                                <div className="row">
                                    <div className="col-6">
                                        <p><strong>Orders This Month:</strong> {overview.orders.this_month}</p>
                                        <p><strong>Revenue This Month:</strong> €{overview.revenue.this_month}</p>
                                    </div>
                                    <div className="col-6">
                                        <p><strong>Active Restaurants:</strong> {overview.restaurants.active}</p>
                                        <p><strong>Average Rating:</strong> {overview.reviews.average_rating}/5</p>
                                    </div>
                                </div>
                                <div className="mt-3">
                                    <h6>Order Status:</h6>
                                    ...
                                    <div key={order.id} className="d-flex justify-content-between align-items-center mb-2">
                                        <div>
                                            ...
                                            <small className="text-muted">
                                                {order.user?.first_name} {order.user?.last_name} - €{order.total_amount}
                                            </small>
                                        </div>
                            ...
                            <tbody>
                                {meals.map((meal) => (
                                    <tr key={meal.id}>
                                        ...
                                        <td>
                                            <span className={`badge bg-${meal.quantity > 0 ? 'success' : 'danger'}`}>
                                                {meal.quantity}
                                            </span>
                                        </td>
    ...
    const renderAnalytics = () => (
        <div>
            <div className="card">
                ...
                <div className="card-body">
                    <p className="text-muted">Advanced analytics and reporting features will be implemented here.</p>
                    <div className="row">
                        <div className="col-md-6">
                            <div className="card">
                                <div className="card-body">
                        ...
                        <div className="col-md-6">
                            <div className="card">
                                <div className="card-body">
                                    <h6>User Growth</h6>
                                    <p className="text-muted">Chart showing user registration trends</p>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <button
                                ...
                                onClick={() => {
                                    ...
                                    if (newPage >= 1) {
                                        ...
                                        if (activeTab === 'users') fetchUsers(newPage, searchTerm, roleFilter);
                                        else if (activeTab === 'restaurants') fetchRestaurants(newPage, searchTerm);
                                        else if (activeTab === 'orders') fetchOrders(newPage, statusFilter);
                                        else if (activeTab === 'meals') fetchMeals(newPage, searchTerm);
                                    }
                                }}
                            >
                                Previous
                        ...
                        {Array.from({ length: totalPages }, (_, i) => i + 1).map((page) => (
                            <li key={page} className={`page-item ${currentPage === page ? 'active' : ''}`}>
                                <button
                                    ...
                                    onClick={() => {
                                        setCurrentPage(page);
                                        if (activeTab === 'users') fetchUsers(page, searchTerm, roleFilter);
                                        else if (activeTab === 'restaurants') fetchRestaurants(page, searchTerm);
                                        else if (activeTab === 'orders') fetchOrders(page, statusFilter);
                                        else if (activeTab === 'meals') fetchMeals(page, searchTerm);
                                    }}
                                >
                                    {page}
                                </button>
