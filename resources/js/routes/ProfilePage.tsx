...
const ProfilePage: React.FC = () => {
  ...
  const totalMoneySaved = useMemo(() => {
    return completedOrders.reduce((total, order) => {
      return (
        total +
        order.order_items.reduce((itemTotal, item) => {
          ...
          return (
            itemTotal + (savedPerItem > 0 ? savedPerItem * item.quantity : 0)
          );
        }, 0)
      );
    }, 0);
        ...
        <div className="row justify-content-center">
          <div className="col-md-6 text-center">
            ...
            <div className="d-grid gap-2 d-md-block">
              <a href="/login" className="btn btn-primary me-md-2">
                Login
              </a>
  ...
  if (!profile) {
    return (
      <div className="alert alert-warning">Could not load profile data.</div>
    );
  }
