...
describe('RestaurantApplicationPage', () => {
  ...
  it('renders application header with correct styling', () => {
    ...
    expect(screen.getByText(/Join our mission to reduce food waste/)).toBeInTheDocument();
  ...
  it('displays application form', () => {
    ...
    expect(screen.getByLabelText('Cuisine Type (e.g., Italian, Lebanese, Cafe)')).toBeInTheDocument();
    expect(screen.getByLabelText('Brief Description / Why you want to join')).toBeInTheDocument();
  });
  ...
  it('allows form input', () => {
    ...
    const cuisineTypeInput = screen.getByLabelText('Cuisine Type (e.g., Italian, Lebanese, Cafe)');
    const descriptionInput = screen.getByLabelText('Brief Description / Why you want to join');
    ...
    fireEvent.change(descriptionInput, { target: { value: 'A great restaurant' } });
  ...
  it('submits form successfully', async () => {
    ...
    fireEvent.change(screen.getByLabelText('Cuisine Type (e.g., Italian, Lebanese, Cafe)'), { 
      target: { value: 'Italian' } 
    });
    fireEvent.change(screen.getByLabelText('Brief Description / Why you want to join'), { 
