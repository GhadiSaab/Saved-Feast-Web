...
export const orderApi = {
  ...
  getMyOrders: async (filters?: OrderFilters): Promise<OrdersResponse> => {
    ...
    const response = await axios.get(`${API_BASE}/me/orders?${params.toString()}`);
  ...
  cancelMyOrder: async (orderId: string, data: CancelOrderRequest): Promise<OrderResponse> => {
    const response = await axios.post(`${API_BASE}/orders/${orderId}/cancel-my-order`, data);
    return response.data;
  },

  // Resend pickup code
  resendCode: async (orderId: string): Promise<OrderResponse> => {
    const response = await axios.post(`${API_BASE}/orders/${orderId}/resend-code`);
    return response.data;
  },
...
export const providerOrderApi = {
  ...
  getOrders: async (filters?: OrderFilters): Promise<OrdersResponse> => {
    ...
    const response = await axios.get(`${API_BASE}/provider/orders?${params.toString()}`);
    return response.data;
  },
  ...
  // Accept order
  acceptOrder: async (orderId: string, data: AcceptOrderRequest): Promise<OrderResponse> => {
    const response = await axios.post(`${API_BASE}/provider/orders/${orderId}/accept`, data);
    return response.data;
  },

  // Mark order as ready
  markReady: async (orderId: string): Promise<OrderResponse> => {
    const response = await axios.post(`${API_BASE}/provider/orders/${orderId}/mark-ready`);
    return response.data;
  },

  // Complete order with code
  completeOrder: async (orderId: string, data: CompleteOrderRequest): Promise<OrderResponse> => {
    const response = await axios.post(`${API_BASE}/provider/orders/${orderId}/complete`, data);
    return response.data;
  },

  // Cancel order by restaurant
  cancelOrder: async (orderId: string, data: CancelOrderByRestaurantRequest): Promise<OrderResponse> => {
    const response = await axios.post(`${API_BASE}/provider/orders/${orderId}/cancel`, data);
    return response.data;
  },
